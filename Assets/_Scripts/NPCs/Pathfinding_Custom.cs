...
{       
    public static List<GridNode> FindPath(GridNode startNode, GridNode targetNode) {
        ...
        while (toSearch.Any()) {
            ...
            foreach (GridNode neighbor in current.neighbouringNodes.Where(t => t.nodeData.isWalkable && t.currentOccupant.occupantType != GridNodeOccupantType.NPC && t.currentOccupant.occupantType != GridNodeOccupantType.NPCInaccessible && t.currentOccupant.occupantType != GridNodeOccupantType.Obstacle && !processed.Contains(t))) {
